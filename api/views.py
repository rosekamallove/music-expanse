...
'''
An APIView which will let us create a room with the args provided in the POST 
request from the frontend to the API endpoint /create-room.
'''
...
'''
API end point that allows us to delete the room that we want to leave
'''
...
'''
A view to update a room thorough the settings page in the room page
'''
